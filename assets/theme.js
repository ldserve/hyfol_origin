    ...
    var Cart = /*#__PURE__*/function () {
        ...
        _createClass(Cart, [{
            ...
            value: function _rerender() {
                var _this2 = this;
                let count = document.querySelector('.header__cart-count')
                count = count ? count.innerHTML : 0
                sessionStorage.setItem('cartNumBefore', count)
                ...
                return fetch(url, {
                    ...
                    content.text().then(function (html) {
                        ...
                        sessionStorage.setItem('cartNumAfter', _this2.itemCount)
                        if (window.theme.cartType !== 'page') {
                            if (window.theme.pageType !== 'cart') {
    ...
    var ls_rias = createCommonjsModule(function (module) {
        (function (window, factory) {
            ...
            addEventListener('lazybeforesizes', function (e) {
                ...
                var elem, src, elemOpts, parent, sources, i, len, sourceSrc, sizes, detail, hasPlaceholder, modified,
                    emptyList;
                elem = e.target;
